//
//  AdminViewClientDatabaseService.swift
//  NCN BackEnd
//
...
import Foundation
public class AdminViewClientDatabaseService {
    public init() {}
    var db = Database.shared
    var resultUser: [User] = []
}

extension AdminViewClientDatabaseService: AdminViewClientDatabaseContract {
