//
//  TrackClientServiceDatabaseService.swift
//  NCN BackEnd
//
...
import Foundation
public class TrackClientServiceDatabaseService {
    public init() {}
    var db = Database.shared
}

extension TrackClientServiceDatabaseService: TrackClientServiceDatabaseContract {
