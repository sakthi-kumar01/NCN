//
//  EmployeeViewClientDatabaseService.swift
//  NCN BackEnd
//
...
import Foundation
public class EmployeeViewClientDatabaseService {
    public init() {}
    var db = Database.shared
    var resultUser: [User] = []
}

extension EmployeeViewClientDatabaseService: EmployeeViewClientDatabaseContract {
