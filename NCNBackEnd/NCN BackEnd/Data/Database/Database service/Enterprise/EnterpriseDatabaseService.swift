...
extension EnterpriseDatabaseService {
    ...
    func createEnterpriseTable() {
        ...
        let foreignKeyConstraints: [String] = [ ", PRIMARY KEY(\"enterpriseId\" AUTOINCREMENT)"]
    ...
    func createQueryTypeTable() {
        ...
        let foreignKeyConstraints: [String] = [", PRIMARY KEY (\"queryTypeId\" AUTOINCREMENT)"]
...
//    
    ...
    func createAvaialablesubscription() {
        ...
        let columnNames = ["subscriptionId","subscriptionPackageType","subscriptionCountLimit","subscritptionDayLimit","serviceId", "enterpriseId"]
    ...
    func createServiceLinkTable() {
        ...
        let columnNames = ["id", "userId", "employeeId", "serviceId", "subscriptionId"]
        
        let columnTypes = ["INTEGER NOT NULL UNIQUE", "INTEGER NOT NULL", "INTEGER NOT NULL", "INTEGER NOT NULL", "INTEGER NOT NULL"]
